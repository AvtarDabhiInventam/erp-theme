        ...
        <Grid container spacing={6}>
          <Grid item sm={6} xs={12}>
            <FormControl fullWidth>
              ...
              <FormControlLabel value='checked' control={<Radio />} label='Corporation Tax' />
            </FormControl>
          </Grid>
          <Grid item sm={6} xs={12}>
            <FormControl fullWidth>
              <FormControlLabel value='checked' control={<Radio />} label='Income Tax' />
            </FormControl>{' '}
          </Grid>
          <Grid item xs={12}>
            <Typography variant='body2' sx={{ fontWeight: 600 }}>
          ...
          <Grid item sm={6} xs={12}>
            <FormControl fullWidth>
              <InputLabel id='status-select'>Select Type of Payment</InputLabel>
              <Select
                defaultValue='Select Type of Payment'
                fullWidth
