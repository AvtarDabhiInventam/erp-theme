...
const SubCompanyMasterProfile = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Sub Company List' sx={{ pb: 4, '& .MuiCardHeader-title': { letterSpacing: '.15px' } }} />
          <CardActions sx={{ flexWrap: 'wrap', gap: '10px' }}>
            <Button size='large' type='submit' variant='contained' onClick={() => router.push('/Masters/sub-company-master')}>
              Add
            </Button>
...
export default SubCompanyMasterProfile
