...
const SalesOrderOpening = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Sales Order List' sx={{ pb: 4, '& .MuiCardHeader-title': { letterSpacing: '.15px' } }} />
          <CardActions sx={{ flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Button size='large' type='submit' variant='contained' onClick={() => router.push('/transaction/sales-order-opening-details')}>
              Edit
            </Button>
...
export default SalesOrderOpening
