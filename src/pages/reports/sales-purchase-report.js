...
const salesPurchaseReport = () => {
  ...
  return (
    <Card>
      <CardHeader title='Outstanding Report' />
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} sm={4}>
              <FormControl fullWidth>
                <InputLabel id='form-layouts-separator-select-label'>Select OutStanding Report</InputLabel>
                <Select
                  label='Country'
                  defaultValue=''
            ...
            <Grid item xs={12} sm={4}>
              <FormControl fullWidth>
                <InputLabel id='form-layouts-separator-select-label'>Select From</InputLabel>
                <Select
                  label='Country'
                  defaultValue=''
                  id='form-layouts-separator-select'
