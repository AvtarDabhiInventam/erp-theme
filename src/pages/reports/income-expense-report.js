...
const IncomeExpenseReport = () => {
  ...
  return (
    <Card>
      <CardHeader title='IncomeExpense Report' />
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value='Credit Note On Income'>Credit Note On Income</MenuItem>
                  <MenuItem value='Credit Note On Sales'>Credit Note On Sales</MenuItem>
                  <MenuItem value='Debit Note On Income'>Debit Note On Income</MenuItem>
                  <MenuItem value='Debit Note On Expense'>Debit Note On Expense</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value='ItemWise Report'>ItemWise Report</MenuItem>
                </Select>
              </FormControl>
            </Grid>
          </Grid>
