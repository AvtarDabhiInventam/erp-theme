...
const outstandingReport = () => {
  ...
  return (
    <Card>
      <CardHeader title='Sales Purchase Report' />
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} sm={4}>
              <FormControl fullWidth>
                <InputLabel id='form-layouts-separator-select-label'>Select Sales Purchase Report</InputLabel>
                <Select
                  label='Country'
                  defaultValue=''
            ...
            <Grid item xs={12} sm={4}>
              <FormControl fullWidth>
                <InputLabel id='form-layouts-separator-select-label'>Select Sales Purchase From</InputLabel>
                <Select
                  label='Country'
                  defaultValue=''
                  id='form-layouts-separator-select'
